  ...
  return (
    <nav className="fixed left-0 top-0 h-full w-[80px] flex flex-col items-center bg-sidebar-bg z-50">
      ...
      <div className="flex flex-col gap-1 w-full overflow-y-auto flex-grow no-scrollbar">
        ...
        <NavLink to="/advisor-dashboard" className={({ isActive }) => `w-full flex flex-col items-center justify-center py-4 text-center transition-colors duration-200 ${isActive ? 'text-active-green border-l-4 border-active-green bg-white/5' : 'text-white/70 hover:text-white hover:bg-white/10'}`}>
          <span className="material-symbols-outlined mb-1">badge</span>
          <span className="text-[10px] font-medium leading-[14px] px-1">Advisor</span>
        </NavLink>
        <NavLink to="/customer-720" className={({ isActive }) => `w-full flex flex-col items-center justify-center py-4 text-center transition-colors duration-200 ${isActive ? 'text-active-green border-l-4 border-active-green bg-white/5' : 'text-white/70 hover:text-white hover:bg-white/10'}`}>
          <span className="material-symbols-outlined mb-1">person_search</span>
          <span className="text-[10px] font-medium leading-[14px] px-1">Customer 720</span>
        </NavLink>
        <NavLink to="/my-day" className={({ isActive }) => `w-full flex flex-col items-center justify-center py-4 text-center transition-colors duration-200 ${isActive ? 'text-active-green border-l-4 border-active-green bg-white/5' : 'text-white/70 hover:text-white hover:bg-white/10'}`}>
          <span className="material-symbols-outlined mb-1">calendar_today</span>
          <span className="text-[10px] font-medium leading-[14px] px-1">My Day</span>
        </NavLink>
